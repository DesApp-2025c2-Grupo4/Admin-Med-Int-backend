...
const {dataFormRoutes, personaRoutes, grupoRoutes, tipoDocRoutes, planMedicoRoutes, telefonoRoutes, emailRoutes, direccionRoutes, situacionRoutes, prestadorRoutes, agendaRoutes, diasRoutes } = require('./routes') 
